...
export const UNITS: Record<string, {
  ...
  villager: { hp: 30, dmg: 3, range: 16, cd: 1.0, speed: 62, aggro: 0, cost: cost({ food: 50 }), time: 7, r: 10, name: 'Villager' },
  swordsman: { hp: 70, dmg: 9, range: 18, cd: 0.9, speed: 74, aggro: 130, cost: cost({ food: 40, gold: 25 }), time: 9, r: 11, name: 'Swordsman' },
}

export const BUILDINGS: Record<string, {
  hp: number; r: number; cost: Cost; time: number; pop: number; name: string
}> = {
  towncenter: { hp: 800, r: 52, cost: cost({ wood: 200, stone: 150 }), time: 45, pop: 5, name: 'Town Hall' },
  house: { hp: 200, r: 26, cost: cost({ wood: 50 }), time: 12, pop: 5, name: 'House' },
  farm: { hp: 120, r: 24, cost: cost({ wood: 60 }), time: 10, pop: 0, name: 'Farm' },
  barracks: { hp: 350, r: 40, cost: cost({ wood: 150 }), time: 20, pop: 0, name: 'Barracks' },
  lumbercamp: { hp: 200, r: 26, cost: cost({ wood: 75 }), time: 13, pop: 0, name: 'Lumber Camp' },
  miningcamp: { hp: 200, r: 26, cost: cost({ wood: 75 }), time: 13, pop: 0, name: 'Mining Camp' },
}
